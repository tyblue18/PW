      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-left">
            {/* Name with typing */}
            <h1 
              className={`text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-white via-teal-200 to-cyan-200 bg-clip-text text-transparent ${
            ...
            >
              <p className="text-2xl md:text-3xl font-semibold text-white mb-4 font-mono">
                {typedTagline}
              ...
              <div className="flex flex-wrap gap-3 text-sm text-gray-400 font-mono">
            ...
            {/* Description */}
            <p 
              className={`text-lg text-gray-400 mb-8 leading-relaxed transition-all duration-1000 delay-300 ${
            ...
            >
              ...
              <button
                ...
                className="px-6 py-3 bg-white/5 backdrop-blur-sm text-white font-semibold rounded border border-white/20 hover:bg-white/10 hover:border-teal-500/50 transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 focus:ring-offset-black"
              >
                View Resume
              </button>
            </div>
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-lg overflow-hidden border-2 border-teal-500/30 bg-gradient-to-br from-teal-900/20 to-purple-900/20 shadow-2xl">
